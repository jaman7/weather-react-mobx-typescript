...
const GeocoderControl = inject('WeatherStore')(
  observer((props: GeocoderControlProps) => {
    ...
    const geocoder = useControl<MapboxGeocoder>(
      () => {
        ...
        if (results.city === 'Zakopane') {
          setMarker(
            <Marker
              longitude={(results?.longitude as number) ?? 0}
              latitude={results?.latitude ?? 0}
              anchor="bottom"
            />
          );
        } else {
        ...
        ctrl.on('result', (evt) => {
          ...
          const { result, result: { text = '', place_name = '' } = {} } =
            evt || {};
    ...
    if (geocoder?._map) {
      switch (true) {
        case geocoder.getProximity() !== props.proximity &&
          props.proximity !== undefined:
          geocoder.setProximity(props.proximity);
          break;
        case geocoder.getRenderFunction() !== props.render &&
          props.render !== undefined:
          geocoder.setRenderFunction(props.render);
          break;
        case geocoder.getLanguage() !== props.language &&
        ...
        case geocoder.getFlyTo() !== props.flyTo && props.flyTo !== undefined:
          ...
          break;
        case geocoder.getPlaceholder() !== props.placeholder &&
          props.placeholder !== undefined:
          geocoder.setPlaceholder(props.placeholder);
          break;
        case geocoder.getCountries() !== props.countries &&
        ...
        case geocoder.getTypes() !== props.types && props.types !== undefined:
          ...
          break;
        case geocoder.getMinLength() !== props.minLength &&
        ...
        case geocoder.getLimit() !== props.limit && props.limit !== undefined:
          ...
          break;
        case geocoder.getFilter() !== props.filter &&
          props.filter !== undefined:
          geocoder.setFilter(props.filter);
          break;
        case geocoder.getOrigin() !== props.origin &&
